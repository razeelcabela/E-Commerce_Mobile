...
class _RiderApplicationFormScreenState
  ...
  Future<void> _submitApplication() async {
    ...
    if (error != null) {
      ...
      await RiderApplicationService.syncRole(
          userEmail, RiderApplicationService.roleRider);
  ...
  bool _validateForm() {
    ...
    if (_licenseCtrl.text.isEmpty) {
      _snack('Please enter your driver\'s license number');
      return false;
    }
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Become a rider and start earning. Fill out the form below to apply.',
                  style: TextStyle(
                    fontSize: 12,
                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 4),
                                Text(
                                  'By applying, you agree to our delivery standards, conduct policy, and commission terms.',
                                  style: TextStyle(
                                    fontSize: 10,
                ...
                Container(
                  ...
                  child: const Text(
                    ...
                    'Once approved, you can log in to the Rider Portal and '
